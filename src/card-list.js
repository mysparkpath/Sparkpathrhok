  ...
  paths: [
    ...
    },
    {
      ...
      en: {
        ...
        blurb_1:
          'magine how people will move from place to place in the future... What if the main mode of transport was renewably powered, autonomous vehicles that pick us up on demand? These pods could be stored on rooftops, eliminating the need for parking lots and thus allowing for more green space.',
        careers: [
          'Urban Planner',
